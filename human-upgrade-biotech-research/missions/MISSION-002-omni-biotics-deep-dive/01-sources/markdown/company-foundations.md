---
type: source
title: "OMNi-BiOTiC company foundations"
sourceUrl: "https://www.allergosan.com/en/about-us/"
accessDate: 2026-04-15
sourceType: website
mission: MISSION-002-omni-biotics-deep-dive
tags: [source, organization, company, leadership, operations]
confidence: high
---

# OMNi-BiOTiC Company Foundations

## Primary Sources

- `https://www.allergosan.com/en/about-us/`
- `https://www.allergosan.com/en/research-and-cooperations/`
- `https://omnibioticlife.com/pages/about-us`
- `https://omnibioticlife.com/pages/press`
- `https://omnibioticlife.com/pages/research`
...
- The Austrian site does not present a classic corporate board profile, but it does describe a highly qualified advisory team of doctors, pharmacists, biologists, nutritionists, and microbiologists.
- The company highlights collaboration with university clinics and research centers in Europe and beyond.
- The official research pages organize publications by indication area, which is a useful proxy for how the company frames its evidence base.

## Operational Context

- The official site states the company is active in approximately 40 countries.
- The company is publicly described as a market leader in Austria and Germany for medically relevant probiotics.
- Official pages do not publish revenue.
