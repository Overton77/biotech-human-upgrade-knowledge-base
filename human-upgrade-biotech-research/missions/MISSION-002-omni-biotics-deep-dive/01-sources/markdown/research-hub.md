---
type: source
title: "OMNi-BiOTiC research hub and clinical studies"
sourceUrl: "https://omnibioticlife.com/pages/research"
accessDate: 2026-04-15
sourceType: website
mission: MISSION-002-omni-biotics-deep-dive
tags: [source, research, trials, publications, clinical-studies]
confidence: high
---

# OMNi-BiOTiC Research Hub and Clinical Studies

## Official Research Pages

| Page | Focus |
|---|---|
| `https://omnibioticlife.com/pages/research` | Index of product-linked publications and educational research summaries |
| `https://omnibioticlife.com/pages/clinicalstudies` | Product-by-product clinical study catalog |
| `https://omnibioticlife.com/pages/gut-brain-axis` | Stress Release and gut-brain studies |
| `https://omnibioticlife.com/pages/gut-antibiotic-impact` | AB 10 and gut restoration studies |
| `https://omnibioticlife.com/pages/gut-liver-axis` | Hetox and gut-liver / cardiometabolic studies |
| `https://omnibioticlife.com/pages/gut-maternal-neonatal` | Panda and maternal / infant studies |
| `https://omnibioticlife.com/pages/gut-athletic-performance` | Power and athletic-performance studies |
| `https://omnibioticlife.com/pages/gut-immunity-connection` | Balance and immune / GALT studies |
...
| Product / Area | Study | Year | Relation |
|---|---|---:|---|
| Stress Release | `Probiotics drive gut microbiome triggering emotional brain signatures` | 2018 | Final-formulation RCT; gut-brain axis |
...
| AB 10 | `Dysbiosis in Early Sepsis can be Modulated by a Multispecies Probiotic` | 2019 | Final-formulation pilot trial |
| Balance | `Influencing Secretory IgA Deficiencies in Sports Students through Nutritional Supplements` | 1999 | Legacy immune/GALT evidence |
| Balance | `Selection of Probiotic Bacteria for Prevention of Allergic Diseases...` | 2007 | Mechanistic / neonatal immune selection |
| Balance | `The Effects of Selected Probiotic Strains on the Development of Eczema (PandA study)` | 2009 | Final-formulation RCT |
| Hetox | `Randomised clinical trial: the effects of a multispecies probiotic vs. placebo on innate immune function... in patients with cirrhosis` | 2016 | Final-formulation RCT; gut-liver axis |
| Hetox | `Effects of a 6-month multi-strain probiotics supplementation... in T2DM patients` | 2018 | Final-formulation RCT; cardiometabolic |
| Hetox | `Effects of a multi-strain probiotic supplement for 12 weeks in circulating endotoxin levels...` | 2017 | Final-formulation clinical trial |
| Panda | `The Effects of Selected Probiotic Strains on the Development of Eczema (the PandA study)` | 2009 | Final-formulation RCT |
| Panda | `Probiotic Supplementation Influences Faecal Short Chain Fatty Acids in Infants at High Risk for Eczema` | 2015 | Follow-on RCT |
| Power | `Probiotic Supplements Beneficially Affect Tryptophan-Kynurenine Metabolism... in Trained Athletes` | 2016 | Final-formulation RCT |
| Power | `Probiotic supplementation affects markers of intestinal barrier, oxidation, and inflammation in trained men` | 2012 | Final-formulation RCT |
| Caricol | `Papaya preparation (Caricol®) in digestive disorders` | 2012 | Company-linked clinical study |
| Caricol | `Impact of Caricol on IBS symptom management` | 2009 | Company-linked clinical study |
| Caricol | `Use of Caricol for pregnancy-related digestive health` | 2019 | Company-linked observational study |
...
- `NCT06929364` - probiotics in endometriosis (ProMetrioS); sponsor: Institut AllergoSan
- `NCT04471116` - probiotic influence on vaginal microbiota; collaborator: Institut AllergoSan
